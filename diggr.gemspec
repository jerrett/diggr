...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "Rakefile", "lib/diggr.rb", "lib/diggr/api.rb", "lib/diggr/api_error.rb", "lib/diggr/constants.rb", "lib/diggr/json_parser.rb", "lib/diggr/request.rb", "lib/diggr/response_classes/comment.rb", "lib/diggr/response_classes/container.rb", "lib/diggr/response_classes/digg.rb", "lib/diggr/response_classes/error.rb", "lib/diggr/response_classes/medium.rb", "lib/diggr/response_classes/photo.rb", "lib/diggr/response_classes/story.rb", "lib/diggr/response_classes/topic.rb", "lib/diggr/response_classes/user.rb", "lib/diggr/response_classes/short_url.rb", "test/test_api.rb", "test/test_comment.rb", "test/test_container.rb", "test/test_digg.rb", "test/test_error.rb", "test/test_json_parser.rb", "test/test_medium.rb", "test/test_photo.rb", "test/test_request.rb", "test/test_story.rb", "test/test_topic.rb", "test/test_user.rb", "test/test_short_url.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://github.com/drewolson/diggr}
  s.rdoc_options = ["--main", "README.txt"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{diggr}
  s.rubygems_version = %q{1.1.4}
  s.summary = %q{Diggr is a ruby wrapper for the Digg API}
  s.test_files = ["test/test_api.rb", "test/test_comment.rb", "test/test_container.rb", "test/test_digg.rb", "test/test_error.rb", "test/test_json_parser.rb", "test/test_medium.rb", "test/test_photo.rb", "test/test_request.rb", "test/test_story.rb", "test/test_topic.rb", "test/test_user.rb", "test/test_short_url.rb"]
